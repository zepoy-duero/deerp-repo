...
function showModalCreateNewLogoInformation() {
  $(gModal).find(".modal-title").text("Create New Logo Entry")
  $(gModal).find("#inpLibraryTypeCode").val("LOGO")
  $(gModal).modal("show")
...
async function showModalEditLogoInformation(libraryInformationCode) {
  $(gModal).find(".modal-title").text("Edit Logo Information")
  $(gModal).modal("show")
  ...
  $(gFormLibraryInformation).find("#inpLibraryTypeCode").val("LOGO")
}
