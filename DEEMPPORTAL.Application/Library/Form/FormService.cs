...
namespace DEEMPPORTAL.Application.Library.Form;
...
public class FormService(IFormRepository formRepository) : IFormService
{
    ...
    {
        return await _formRepository.DeleteLibraryInformation(libraryInformationCode);
    }

    public async Task<IEnumerable<LibraryInformationResponse>> GetAllLibraryInformation(int orgCode)
    {
        return await _formRepository.GetAllLibraryInformation(orgCode);
    }

    public async Task<LibraryInformationResponse> GetLibraryInformation(int libraryInformationCode)
    {
        return await _formRepository.GetLibraryInformation(libraryInformationCode);
    }
    ...
    public async Task<bool> SaveLibraryInformation(LibraryInformationRequest request)
    {
        ...
        return await _formRepository.SaveLibraryInformation(dt);
    }

    public async Task<IEnumerable<LibraryAttachmentResponse>> GetAllLibraryAttchment(int libraryInformationCode)
    {
        return await _formRepository.GetAllLibraryAttchment(libraryInformationCode);
    }

    public async Task<bool> DeleteLibraryAttachment(int libraryInformationCode)
    {
        return await _formRepository.DeleteLibraryAttachment(libraryInformationCode);
    }
    ...
    public async Task<bool> InsertLibraryAttachment(int libraryInformationCode, IFormFile file)
    {
        ...
        return await _formRepository.InsertLibraryAttachment(dataList);
    }

    public async Task<LibraryAttachmentResponse> GetLibraryAttachment(int libraryAttachmentCode)
    {
        return await _formRepository.GetLibraryAttachment(libraryAttachmentCode);
    }
}
