...
public class CreditApplicationService(ICreditApplicationRepository creditApplicationRepository) : ICreditApplicationService
{
    ...
    {
        return await _creditApplicationRepository.DeleteLibraryInformation(libraryInformationCode);
    }

    public async Task<IEnumerable<LibraryInformationResponse>> GetAllLibraryInformation(int orgCode)
    {
        return await _creditApplicationRepository.GetAllLibraryInformation(orgCode);
    }

    public async Task<LibraryInformationResponse> GetLibraryInformation(int libraryInformationCode)
    {
        return await _creditApplicationRepository.GetLibraryInformation(libraryInformationCode);
    }
    ...
    public async Task<bool> SaveLibraryInformation(LibraryInformationRequest request)
    {
        ...
        return await _creditApplicationRepository.SaveLibraryInformation(dt);
    }

    public async Task<IEnumerable<LibraryAttachmentResponse>> GetAllLibraryAttchment(int libraryInformationCode)
    {
        return await _creditApplicationRepository.GetAllLibraryAttchment(libraryInformationCode);
    }

    public async Task<bool> DeleteLibraryAttachment(int libraryInformationCode)
    {
        return await _creditApplicationRepository.DeleteLibraryAttachment(libraryInformationCode);
    }
    ...
    public async Task<bool> InsertLibraryAttachment(int libraryInformationCode, IFormFile file)
    {
        ...
        return await _creditApplicationRepository.InsertLibraryAttachment(dataList);
    }

    public async Task<LibraryAttachmentResponse> GetLibraryAttachment(int libraryAttachmentCode)
    {
        return await _creditApplicationRepository.GetLibraryAttachment(libraryAttachmentCode);
    }
}
